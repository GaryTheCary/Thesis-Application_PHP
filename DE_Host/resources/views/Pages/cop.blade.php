...
<link rel="stylesheet" type="text/css" href="/css/cop_companion.css">
@endsection
...
<div class="analysis_area">
	<div class="visulization_section">
		...
		<div class="bar_title">
			<div class="title"><p> C. (CENTER) O. (Of) P. (Pressure) Curve Graph</p></div>
			<div class="checkbox_panel">
				...
				<div class="checkbox_field">
					<button class="mini ui inverted yellow button" id="BTNUpdate">
						Update
					</button>
				</div>
...
<script type="text/javascript" src="/script/cop.js"></script>
@endsection